...
import RMenuHeader from './components/RMenuHeader';

const RequesterMenuDescription = () => (
  <View style={styles.container}>
    <RMenuHeader text="กรุณาเลือกร้านอาหาร" />
    <View style={{marginTop:20,marginBottom:10}}>
        <Text>ค้นหาร้านอาหาร</Text>
        <View style={{backgroundColor: 'gray',width: 360, height: 40}}>
        <TextInput/>
        </View>
    </View>
...
export default RequesterMenuDescription;
